<!-- The css is in blog-form component -->

<title>write blog | History</title>
<x-blogForm heading="HISTORY" />

<form action="/writeBlogHistory" method="post" enctype='multipart/form-data' >
@csrf
...
<center> <p> <a class="footerHome" href="/">HOME</a></p> </center>
 ...
 <!--  whenever "writeBlogHistory" is clicked then move to blogHistoryImage upload section -->